				...
				<div id="paginationBox" style="text-align: center;">
					<ul class="pagination" style="margin-top: 10px">
						<c:if test="${pagination.prevPage}">
							<li class="page">
								<a class="button" href="${pageContext.request.contextPath}/board/getRecommendBoardList${pagination.makeSearch(pagination.startPage - 1)}">이전</a>
							</li>
						</c:if>
						...
						<c:if test="${pagination.nextPage && pagination.endPage > 0}">
							<li class="page"><a class="button" href="${pageContext.request.contextPath}/board/getRecommendBoardList${pagination.makeSearch(pagination.endPage + 1)}">다음</a></li>
						</c:if>
					</ul>
				</div>
				<!-- pagination(end) -->
